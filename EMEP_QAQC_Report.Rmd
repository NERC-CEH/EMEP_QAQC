...
if (length(missing_polls) == 0) {
  cat('\n', 'Data for all requested pollutants are available and shown below.', '\n')
} else if (length(missing_polls) == 1) {
  cat('\n', paste0('Data for the requested pollutant ', missing_polls, ' not available.'), '\n')
} else {
  cat('\n\n\n', paste0('Data for the requested pollutants ', str_replace(str_c(missing_polls, collapse = ', '), '(.*),', '\\1 and'), ' not available.'), '\n')
}
