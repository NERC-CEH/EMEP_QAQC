...
```{r mobs_report_selected_map, echo = FALSE, eval = PLOT_MOBS}
...
```{r, echo = F, eval = PLOT_MOBS && nrow(sites_geo_map_sub) != 0, fig.width = 10, fig.height = 10*(domain_dims[2]/domain_dims[1]*1.1), results = 'asis'}
...
```{r, mobs_report_plot_tseries, echo = FALSE, eval = PLOT_MOBS && !is.null(site_plot_selected), fig.width = 10, fig.height = 18, results ='asis'}
